...
class Profile(models.Model):
    ...
    pic_thumbnail=models.ImageField(upload_to='img',blank=True,null=True)
    pic_140x=models.ImageField(upload_to='img',blank=True,null=True)
